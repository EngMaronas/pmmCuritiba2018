...
void loop() {
  ...
  radiopacket[11] = (uint8_t)c_lon;
  radiopacket[12] = ((uint32_t)struct_imu.barometro[0] & 0x000000ff);
  radiopacket[13] = ((uint32_t)struct_imu.barometro[0] & 0x0000ff00) >> 8;
  radiopacket[14] = ((uint32_t)struct_imu.barometro[0] & 0x00ff0000) >> 16;
  radiopacket[15] = ((uint32_t)struct_imu.barometro[0] & 0xff000000) >> 24;
  radiopacket[16] = ((uint32_t)struct_imu.barometro[1] & 0x000000ff);
  radiopacket[17] = ((uint32_t)struct_imu.barometro[1] & 0x0000ff00) >> 8;
  radiopacket[18] = ((uint32_t)struct_imu.barometro[1] & 0x00ff0000) >> 16;
  radiopacket[19] = ((uint32_t)struct_imu.barometro[1] & 0xff000000) >> 24;
  radiopacket[20] = ((uint32_t)struct_imu.barometro[2] & 0x000000ff);
  radiopacket[21] = ((uint32_t)struct_imu.barometro[2] & 0x0000ff00) >> 8;
  radiopacket[22] = ((uint32_t)struct_imu.barometro[2] & 0x00ff0000) >> 16;
  radiopacket[23] = ((uint32_t)struct_imu.barometro[2] & 0xff000000) >> 24;
  radiopacket[24] = ((uint32_t)struct_imu.barometro[3] & 0x000000ff);
  radiopacket[25] = ((uint32_t)struct_imu.barometro[3] & 0x0000ff00) >> 8;
  radiopacket[26] = ((uint32_t)struct_imu.barometro[3] & 0x00ff0000) >> 16;
  radiopacket[27] = ((uint32_t)struct_imu.barometro[3] & 0xff000000) >> 24;
  radiopacket[28] = ((uint32_t)struct_imu.acelerometro[0] & 0x000000ff);
  radiopacket[29] = ((uint32_t)struct_imu.acelerometro[0] & 0x0000ff00) >> 8;
  radiopacket[30] = ((uint32_t)struct_imu.acelerometro[0] & 0x00ff0000) >> 16;
  radiopacket[31] = ((uint32_t)struct_imu.acelerometro[0] & 0xff000000) >> 24;  
  radiopacket[32] = ((uint32_t)struct_imu.acelerometro[1] & 0x000000ff);
  radiopacket[33] = ((uint32_t)struct_imu.acelerometro[1] & 0x0000ff00) >> 8;
  radiopacket[34] = ((uint32_t)struct_imu.acelerometro[1] & 0x00ff0000) >> 16;
  radiopacket[35] = ((uint32_t)struct_imu.acelerometro[1] & 0xff000000) >> 24;  
  radiopacket[36] = ((uint32_t)struct_imu.acelerometro[2] & 0x000000ff);
  radiopacket[37] = ((uint32_t)struct_imu.acelerometro[2] & 0x0000ff00) >> 8;
  radiopacket[38] = ((uint32_t)struct_imu.acelerometro[2] & 0x00ff0000) >> 16;
  radiopacket[39] = ((uint32_t)struct_imu.acelerometro[2] & 0xff000000) >> 24; 
  radiopacket[40] = ((uint32_t)struct_imu.giroscopio[0] & 0x000000ff);
  radiopacket[41] = ((uint32_t)struct_imu.giroscopio[0] & 0x0000ff00) >> 8;
  radiopacket[42] = ((uint32_t)struct_imu.giroscopio[0] & 0x00ff0000) >> 16;
  radiopacket[43] = ((uint32_t)struct_imu.giroscopio[0] & 0xff000000) >> 24;  
  radiopacket[44] = ((uint32_t)struct_imu.giroscopio[1] & 0x000000ff);
  radiopacket[45] = ((uint32_t)struct_imu.giroscopio[1] & 0x0000ff00) >> 8;
  radiopacket[46] = ((uint32_t)struct_imu.giroscopio[1] & 0x00ff0000) >> 16;
  radiopacket[47] = ((uint32_t)struct_imu.giroscopio[1] & 0xff000000) >> 24;  
  radiopacket[48] = ((uint32_t)struct_imu.giroscopio[2] & 0x000000ff);
  radiopacket[49] = ((uint32_t)struct_imu.giroscopio[2] & 0x0000ff00) >> 8;
  radiopacket[50] = ((uint32_t)struct_imu.giroscopio[2] & 0x00ff0000) >> 16;
  radiopacket[51] = ((uint32_t)struct_imu.giroscopio[2] & 0xff000000) >> 24;  
  radiopacket[52] = ((uint32_t)struct_imu.magnetometro[0] & 0x000000ff);
  radiopacket[53] = ((uint32_t)struct_imu.magnetometro[0] & 0x0000ff00) >> 8;
  radiopacket[54] = ((uint32_t)struct_imu.magnetometro[0] & 0x00ff0000) >> 16;
  radiopacket[55] = ((uint32_t)struct_imu.magnetometro[0] & 0xff000000) >> 24;  
  radiopacket[56] = ((uint32_t)struct_imu.magnetometro[1] & 0x000000ff);
  radiopacket[57] = ((uint32_t)struct_imu.magnetometro[1] & 0x0000ff00) >> 8;
  radiopacket[58] = ((uint32_t)struct_imu.magnetometro[1] & 0x00ff0000) >> 16;
  radiopacket[59] = ((uint32_t)struct_imu.magnetometro[1] & 0xff000000) >> 24;  
  radiopacket[60] = ((uint32_t)struct_imu.magnetometro[2] & 0x000000ff);
  radiopacket[61] = ((uint32_t)struct_imu.magnetometro[2] & 0x0000ff00) >> 8;
  radiopacket[62] = ((uint32_t)struct_imu.magnetometro[2] & 0x00ff0000) >> 16;
  radiopacket[63] = ((uint32_t)struct_imu.magnetometro[2] & 0xff000000) >> 24;  
